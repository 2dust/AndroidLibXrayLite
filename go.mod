...
require (
    ...
    gopkg.in/yaml.v2 v2.4.x  // indirectly used for YAML parsing 
)

replace google.golang.org/grpc v1.67.x => google.golang.org/grpc v1.xx.x  # replace with the desired version here.
