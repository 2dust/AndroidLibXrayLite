...
func main() {
	tzErr := dnscrypt_lib.TimezoneSetup()
	...
	flags.ConfigFile = flag.String("config", dnscrypt_lib.DefaultConfigFileName, "Path to the configuration file")
...
func (app *App) Stop(service service.Service) error {
	if err := dnscrypt_lib.PidFileRemove(); err != nil {
